		...
		<form name="myForm">
			<div id="myModal" class="modal hide fade" class="span9">
				...
				<div style="padding-left: 20px; padding-right: 10px">
					<br /> <b>Looks like you are either out of cash or you have insufficient funds for
					booking tickets. Please deposit more money in your account to continue enjoying
