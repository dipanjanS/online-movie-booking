...
<body>
	<div class="container-fluid" id="panel"
		...
		<div align="center">
			<font style="font-size: 35px; color: red;">Congratulations !!! Your password has been changed successfully!</font>
		</div>
		...
		<form name="myForm">
			<div id="myModal" class="modal hide fade" class="span9">
				...
				<div style="padding-left: 20px; padding-right: 10px">
					<br />
					<b>Congratulations !!!<br />Your password has been changed successfully!
					</b> <br />
					<br />
